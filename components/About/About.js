    ...
    return (
      ...
      >
        ...
        <div className={styles.timelineTextBox}>
          ...
          <h5>{achievement.level} - {achievement.year}</h5>
  ...
  const displayHobby = hobbyList.map((hobby, index) => {
    return (
      <div key={index} className={styles.hobbyWrapper}>
        <div className={styles.hobbyCont} style={{ backgroundColor: hobby.color }}>
          <Image src={hobby.url} width={150} height={150} alt={hobby.name} />
        </div>
    ...
    <div className={styles.bgContainer}>
      ...
      <div className={styles.aboutContainer}>
        <div>
          ...
          <h1 className={styles.shortAbout}> I&apos;m Jeremy Jhay B. Cayabyab, a passionate front-end developer and UI designer with a focus on creating visually appealing,
            user-friendly interfaces. Currently, I&apos;m a 3rd-year college student taking BS  Computer Science  at Polytechnic University of the Philippines, honing my skills in web development and
            design to craft functional and beautiful  digital experiences.
          </h1>
        </div>


        <div className={styles.hobbiesParentContainer}>
          <div className={`${styles.hobbiesTitleContainer} ${styles.titleContainer}`}>
        ...
        <div className={styles.achievementsParentContainer}>
          <div className={`${styles.achieveTitleContainer} ${styles.titleContainer}`}>
        ...
        <div className={styles.techParentContainer}>
          <div className={`${styles.techTitleContainer} ${styles.titleContainer}`}>
